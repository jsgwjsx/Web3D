...
const geometry = new THREE.BufferGeometry().setFromPoints(CurvePath.getPoints(16))
const material = new THREE.LineBasicMaterial({
    color:0x00ffff
})
const line = new THREE.Line(geometry,material)

const geometry1 = new THREE.BufferGeometry().setFromPoints(CurvePath.getPoints(16))
