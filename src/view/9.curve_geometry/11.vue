...
shape.lineTo(100,0)//此时Shape的currentPoint在xoy平面的(100,0)原点上,相当于画了一条(0,0)到(100,0)的直线
console.log(shape.currentPoint)
//arc绘制相对弧线，不过圆心坐标是相对当前.currentPoint而言,而不是坐标原点。绘制完后，点在结束的角度
shape.arc(0,0,50,0,Math.PI/2)
console.log(shape.currentPoint)
shape.lineTo(0,50)

//通过shape构建填充几何体,会对图像进行自动闭合
