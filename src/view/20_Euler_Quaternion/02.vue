...
const A = new THREE.Vector3(20,0,0)

//创建一个四元数对象Quaternion
const quaternion = new THREE.Quaternion();
//使用.setFromAxisAngle(vec3对象,旋转角度)来辅助生成表示绕vec3对象这个向量旋转对应角度的四元数
...
//向量A.applyQuaternion应用这个四元数实现旋转
