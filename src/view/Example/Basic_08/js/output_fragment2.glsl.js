...
float height = 354.;//楼层最大高度，通过包围盒计算出来的
vec3 color1 = vec3(0,0.1,0.1);//底部颜色
vec3 color2 = vec3(0,1.,1.);//顶部颜色
vec3 perCol = mix(color1,color2,sqrt(vposition.z/height)); 

//设置原始颜色为white，方便计算
outgoingLight = outgoingLight*perCol;
